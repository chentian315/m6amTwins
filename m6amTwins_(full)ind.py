...
def train_feature_extraction():
    se_pp = ("train_full_P.fasta")
    se_nn = ("train_full_N.fasta")
...
def test_feature_extraction():
    se_pp = ("test_full_P.fasta")
    se_nn = ("test_full_N.fasta")
    se_p = SeqIO.parse(se_pp, 'fasta')
    se_n = SeqIO.parse(se_nn, 'fasta')
    # print(str(se_p.seq))
    aa = len(list(se_p))
...
if __name__ == '__main__':
    ...
    for epoch in range(EPOCH):
        ...
        if test_acc >= 0.765:
            ...
            best_tn, best_fp, best_fn, best_tp, best_sn, best_sp, bs, best_mcc = \
                test_res_data[0], test_res_data[1], test_res_data[2], test_res_data[3], test_res_data[4], test_res_data[5], test_res_data[6], test_res_data[7]
